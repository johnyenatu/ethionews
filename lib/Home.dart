...
import 'View/LocalnNews/localAllNews.dart';
            ...
            children: <Widget>[
              ...
              Container(
                child: ListTile(
                  ...
                  onTap: () {
                    Share.share(
                        'check out my website https://play.google.com/store/apps/details?id=instant.ethionews');
                  },
                ),
              ),
              Container(
                child: ListTile(
                  ...
                  onTap: () {
                    launch(
                        'https://play.google.com/store/apps/developer?id=Instant+Systems');
                  },
                ),
              ),
//              new ListTile(
...
//                onTap: () {
//                  Navigator.of(context).push(new MaterialPageRoute(
//                      builder: (context) => SetupInformation()));
//                },
//              )
            ],
          ),
